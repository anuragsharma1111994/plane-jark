...
function download() {
    ...
    curl -H 'Cache-Control: no-cache, no-store' -s -o $PLANE_INSTALL_DIR/docker-compose.yaml  https://raw.githubusercontent.com/anuragsharma1111994/plane-jark/master/deploy/selfhost/docker-compose.yml
    curl -H 'Cache-Control: no-cache, no-store' -s -o $PLANE_INSTALL_DIR/variables-upgrade.env https://raw.githubusercontent.com/anuragsharma1111994/plane-jark/master/deploy/selfhost/variables.env
